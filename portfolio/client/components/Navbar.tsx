...
const Navbar = () => {
  ...
  useEffect(() => {
    // ⚡ Bolt: Use a ticking lock to prevent multiple state updates per frame
    let ticking = false;
    ...
    // ⚡ Bolt: Use passive listener so the browser doesn't block scrolling while executing the listener
