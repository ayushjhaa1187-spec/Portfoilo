                ...
                <div className="mt-auto pt-4 border-t border-gray-50 flex flex-col gap-3">
                   <div className="flex justify-between items-center">
                      ...
                      {('liveUrl' in project && typeof project.liveUrl === 'string' && project.liveUrl) && (
                        <a href={('liveUrl' in project && typeof project.liveUrl === 'string') ? project.liveUrl : '#'} target="_blank" rel="noopener noreferrer" className="text-xs font-bold text-blue-600 hover:underline">
                          LIVE DEMO ↗
                        </a>
                      )}
                   </div>
