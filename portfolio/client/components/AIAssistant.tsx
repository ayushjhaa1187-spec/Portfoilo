          ...
          >
            ...
            <div className="p-4 bg-amber-400 text-black flex justify-between items-center">
              ...
              <button
                ...
                className="hover:bg-black/10 p-1 rounded-full transition-colors focus-visible:ring-2 focus-visible:ring-amber-400 focus-visible:outline-none"
              >
                <X size={18} />
              </button>
            </div>
            ...
            <div className="p-4 border-t border-slate-100 dark:border-white/5 flex gap-2 bg-white dark:bg-slate-950">
              ...
              <button 
                ...
                className="bg-amber-400 text-black p-2.5 rounded-full hover:bg-white transition-colors shadow-lg shadow-amber-400/20 focus-visible:ring-2 focus-visible:ring-amber-400 focus-visible:outline-none focus-visible:ring-offset-2 focus-visible:ring-offset-slate-950"
              >
                <Send size={18} />
              </button>
            </div>
