    ...
    const handleScroll = () => {
      if (!ticking) {
        window.requestAnimationFrame(() => {
          // Optimization: Wrap scroll event updates in requestAnimationFrame and use a ticking lock
          // Impact: Prevents unnecessary state updates and reduces main thread blocking during scroll events, improving scroll performance
