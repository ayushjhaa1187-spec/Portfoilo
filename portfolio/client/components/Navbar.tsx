...
const Navbar = () => {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      if (!ticking) {
        // Optimize: Use requestAnimationFrame to throttle React state updates to screen refresh rate
    ...
    // Optimize: Add { passive: true } to tell the browser the listener won't prevent scroll, improving scroll performance
