        ...
        {isOpen && (
          ...
          >
            ...
            <div className="p-4 bg-amber-400 text-black flex justify-between items-center">
              ...
              <button onClick={toggleChat} aria-label="Close assistant" className="hover:bg-black/10 p-1 rounded-full transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-400">
                <X size={18} />
              </button>
            </div>
