  ...
  return (
    <div className="fixed bottom-6 right-6 z-[9999]">
        ...
        {isOpen && (
          ...
          >
            ...
            <div className="p-4 bg-amber-400 text-black flex justify-between items-center">
              ...
              <button onClick={toggleChat} aria-label="Close AI assistant" className="hover:bg-black/10 p-1 rounded-full transition-colors focus-visible:ring-2 focus-visible:ring-black outline-none">
                <X size={18} />
              </button>
            </div>
            ...
            <div className="p-4 border-t border-slate-100 dark:border-white/5 flex gap-2 bg-white dark:bg-slate-950">
              ...
              <button 
                ...
                className="bg-amber-400 text-black p-2.5 rounded-full hover:bg-white transition-colors shadow-lg shadow-amber-400/20 focus-visible:ring-2 focus-visible:ring-amber-500 focus-visible:ring-offset-2 outline-none"
              >
                <Send size={18} />
              </button>
            </div>
      ...
      <motion.button
        ...
        className="w-16 h-16 bg-amber-400 text-black rounded-full flex items-center justify-center shadow-2xl hover:shadow-amber-400/40 transition-all border-4 border-black group focus-visible:ring-2 focus-visible:ring-amber-400 focus-visible:ring-offset-2 focus-visible:ring-offset-black outline-none"
      >
