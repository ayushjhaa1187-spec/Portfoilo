    ...
    const handleScroll = () => {
      if (!ticking) {
        window.requestAnimationFrame(() => {
          ...
          // Wrapped scroll state updates in requestAnimationFrame to prevent unnecessary
          // re-renders and main thread blocking during scroll events. Expected to reduce
          // rendering overhead on scroll by syncing state updates with display refresh rate.
