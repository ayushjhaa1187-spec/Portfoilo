...
// ⚡ Bolt Optimization: Moved static array outside component to prevent reallocation on every render
const categories = ['ALL', 'ML/AI', 'BUSINESS', 'LABS'];

export const FeaturedProjects = () => {
  const [activeTab, setActiveTab] = React.useState('ALL');

  // ⚡ Bolt Optimization: Memoize the filtered array to prevent O(n) recalculations on re-renders
