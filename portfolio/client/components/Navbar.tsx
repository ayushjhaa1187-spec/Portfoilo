    ...
    const handleScroll = () => {
      if (!ticking) {
        window.requestAnimationFrame(() => {
          // ⚡ Bolt: Optimize scroll event listener to prevent main thread blocking
          // Reduces unnecessary state updates and re-renders by throttling to screen refresh rate (~60fps)
