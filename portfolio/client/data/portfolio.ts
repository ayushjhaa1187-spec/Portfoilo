...
export const projects: Project[] = [
    ...
    },
    {
        ...
        fullDescription: 'Implementation of LLM to automate workflow not task using multi-agent architectures.',
        techStack: ['TypeScript', 'LLMs'],
    ...
    },
    {
        ...
        fullDescription: 'Built the Smart Link Hub for the Advitiya Hackathon 26 utilizing JavaScript and modern frontend mechanics.',
    ...
    },
    {
        ...
        fullDescription: 'Designed scripts to handle rapid catalog synchronization operations.',
        techStack: ['Python'],
    ...
    },
    {
        ...
        fullDescription: 'Category intelligence scripts for categorizing bulk data outputs.',
    ...
    },
    {
        ...
        fullDescription: 'Communication parsing backend leveraging TypeScript and robust logic trees.',
    ...
    },
    {
        ...
        fullDescription: 'Interface and frontend layouts for the DairyDash dairy delivery ecosystem.',
        techStack: ['HTML', 'CSS'],
    ...
    },
    {
        ...
        fullDescription: 'Demand graph tool to chart user demand statistics via scripts.',
        techStack: ['Python'],
    ...
    },
    {
        ...
        fullDescription: 'Foundational Django application demonstrating MVT architectures.',
    ...
    },
    {
        ...
        fullDescription: 'Deep dive into the Enron email dataset using TypeScript node operations.',
        techStack: ['TypeScript', 'Data Analysis'],
    ...
    },
    {
        ...
        fullDescription: 'The microservice deployment architecture for the Enron Insights data output.',
    ...
    },
    {
        ...
        fullDescription: 'Repository housing code and logic for my 2025 Hackathon attendance.',
    ...
    },
    {
        ...
        fullDescription: 'Repository for the concepts generated during the national Ideathon.',
        techStack: ['HTML', 'CSS'],
    ...
    },
    {
        ...
        category: 'ML/AI',
        shortDescription: 'Implementation of LLM to automate workflow not task.',
        fullDescription: 'Experimenting with Large Language Models directly to chain workflows.',
    ...
    },
    {
        ...
        fullDescription: 'Simple Python tool to track daily medication via local OS files.',
        techStack: ['Python'],
    ...
    },
    {
        ...
        fullDescription: 'Service to dissect and summarize meeting intelligence data effectively.',
        techStack: ['TypeScript', 'Node.js'],
    ...
    {
        slug: 'meeting-weaver-insights',
        title: 'Meeting Weaver Insights',
        category: 'Microservices',
        shortDescription: 'Sub-repository for meeting weaver',
        fullDescription: 'Microservice supporting data transformations for the Weaver platform.',
        techStack: ['TypeScript'],
        metrics: { accuracy: 'N/A', impact: 'Services', speed: 'N/A' },
        githubUrl: 'https://github.com/ayushjhaa1187-spec/meeting-weaver-insights',
        featured: false,
        icon: '🎙️',
    },
    {
        ...
        fullDescription: 'Boilerplate and structural testing on the Next.js 14 App Router layout.',
    ...
    },
    {
        ...
        fullDescription: 'The TypeScript React codebase powering this very portfolio.',
    ...
    {
        slug: 'profile-bio',
        title: 'Profile Bio Central',
        category: 'Web Development',
        shortDescription: 'Profile Bio repository details',
        fullDescription: 'Static HTML layout housing link configurations and core bio tags.',
        techStack: ['HTML', 'CSS'],
        metrics: { accuracy: 'N/A', impact: 'Utility', speed: 'N/A' },
        githubUrl: 'https://github.com/ayushjhaa1187-spec/Profile_Bio',
        featured: false,
        icon: '📄',
    },
    {
        ...
        fullDescription: 'Reliability engineering utility for tracking and scraping sites for structural integrity.',
    ...
    },
    {
        ...
        fullDescription: 'Underground CRM operations platform scaffolding.',
    ...
    },
    {
        ...
        fullDescription: 'Scripts aimed at validating and enhancing authentication workflows in TypeScript.',
        techStack: ['TypeScript'],
    ...
    },
    {
        ...
        fullDescription: 'Frontend tracking node and control panel for the StockSense ecosystem.',
    ...
    },
    {
        ...
        fullDescription: 'Python scripts designed to parse and track independent vendor logs.',
        techStack: ['Python'],
        metrics: { accuracy: 'N/A', impact: 'Utility', speed: 'N/A' },
