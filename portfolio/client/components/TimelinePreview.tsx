    ...
    <section className="py-[var(--section-gap)] px-[var(--section-px)] max-w-7xl mx-auto border-t border-white/5">
      <div className="flex flex-col md:flex-row justify-between items-end mb-20 gap-8">
         <motion.div
            ...
            viewport={{ once: true }}
         >
            <p className="text-amber-400 text-xs font-black tracking-[0.4em] uppercase mb-4">Professional_Nodes_Preview</p>
          ...
          >
             <div className="flex flex-col md:flex-row items-center justify-between p-10 gap-8 relative">
                ...
                <div className="flex items-center gap-8 relative z-10">
                   ...
                   <div>
                      <h3 className="text-2xl font-black text-white uppercase tracking-tight group-hover:text-amber-400 transition-colors uppercase leading-none mb-3">{exp.role}</h3>
