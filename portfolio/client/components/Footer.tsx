        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="https://github.com/ayushjhaa1187-spec" target="_blank" rel="noopener noreferrer" aria-label="Visit Ayush's GitHub profile" className="text-slate-400 hover:text-white transition-colors">
                <Github size={24} />
              </a>
              <a href="https://www.linkedin.com/in/ayush-kumar-jha-5960a3362/" target="_blank" rel="noopener noreferrer" aria-label="Visit Ayush's LinkedIn profile" className="text-slate-400 hover:text-white transition-colors">
                <Linkedin size={24} />
              </a>
              <a href="mailto:ayushjhaa1187@gmail.com" aria-label="Send Ayush an email" className="text-slate-400 hover:text-white transition-colors">
                <Mail size={24} />
              </a>
