    ...
    const handleScroll = () => {
      if (!ticking) {
        window.requestAnimationFrame(() => {
          // Optimization: Wraps state updates in requestAnimationFrame using a ticking lock.
          // Expected Performance Impact: Reduces re-renders and main thread blocking during high-frequency scroll events, improving scroll performance and framerate.
