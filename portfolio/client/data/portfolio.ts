...
export const projects: Project[] = [
    ...
    },
    {
        ...
        fullDescription: 'Developed an autonomous AI agent for pharmacy expiry management and inventory optimization. It constantly monitors inventory flow, predicts stockouts, and manages expiry to maximize profitability.',
        techStack: ['Python', 'AI Agents', 'Data Analysis', 'Automation'],
        metrics: { accuracy: 'High', impact: 'Reduced Waste', speed: 'Real-time' },
    ...
    },
    {
        ...
        category: 'ML/AI',
        shortDescription: 'Interactive Python-based voice assistant for hands-free automation.',
        fullDescription: 'A versatile voice assistant capable of performing various tasks completely hands-free. Includes functionality for web search, application control, and natural conversation using different speech recognition and TTS engines.',
        techStack: ['Python', 'SpeechRecognition', 'pyttsx3', 'APIs'],
        metrics: { accuracy: 'N/A', impact: 'Accessibility', speed: 'Fast' },
    ...
    {
        slug: 'ethicallancing',
        title: 'Ethicallancing',
        category: 'Business',
        shortDescription: 'A custom frontend project for an ethical freelancing platform.',
        fullDescription: 'Frontend implementation for a platform that advocates for fair and ethical freelance work. The goal is to provide a transparent and accessible environment for all users involved.',
        techStack: ['HTML', 'CSS', 'JavaScript'],
        metrics: { accuracy: 'N/A', impact: 'Community', speed: 'N/A' },
