...
const Navbar = () => {
  ...
  useEffect(() => {
    ...
    // ⚡ Bolt: Throttling scroll event using requestAnimationFrame to prevent excessive re-renders
    const handleScroll = () => {
      if (!ticking) {
    ...
    // ⚡ Bolt: Added { passive: true } for better scroll performance by not blocking main thread
