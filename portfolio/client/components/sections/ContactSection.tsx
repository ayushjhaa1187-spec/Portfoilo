      ...
      <div className="max-w-[1400px] mx-auto w-full relative z-10 text-center">
        ...
        >
          ...
          <a 
            ...
            className="font-mono text-lg lg:text-3xl text-[#06B6D4] hover:text-[#D4AF37] transition-colors tracking-widest border-b border-[#06B6D4]/30 pb-4"
          >
        ...
        <motion.div 
          ...
          className="flex flex-col md:flex-row items-center justify-center gap-8 mb-48"
        >
          <MagneticButton>
             <a 
              href="mailto:ayushjhaa1187@gmail.com" 
...
function SocialLink({ href, icon: Icon, label }: { href: string; icon: any; label: string }) {
  return (
    <a 
      href={href} 
      target="_blank" 
      className="group flex flex-col items-center gap-4 text-[#555560] hover:text-[#D4AF37] transition-colors"
    >
      <div className="p-4 bg-[#0E0E12] border border-[#1E1E24] group-hover:border-[#D4AF37]/50 transition-all duration-300">
