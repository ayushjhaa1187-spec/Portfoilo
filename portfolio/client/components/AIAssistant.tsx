  ...
  return (
    <div className="fixed bottom-6 right-6 z-[9999]">
      ...
      >
        ...
        <span className="absolute right-full mr-4 bg-amber-400 text-black px-4 py-2 rounded-lg text-[10px] font-black uppercase tracking-[0.2em] whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity shadow-2xl pointer-events-none" aria-hidden="true">
          SYSTEM_ACCESS
        </span>
      </motion.button>
    </div>
