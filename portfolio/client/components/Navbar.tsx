...
const Navbar = () => {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      if (!ticking) {
        // ⚡ Bolt: Wrapped state updates in requestAnimationFrame with a ticking lock to prevent excessive layout thrashing and redundant re-renders during high-frequency scroll events
    ...
    // ⚡ Bolt: Added { passive: true } to scroll event listener to prevent main thread blocking and improve scroll performance
