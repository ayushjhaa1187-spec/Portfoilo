  ...
  return (
    <div className="fixed bottom-6 right-6 z-[9999]">
        ...
        {isOpen && (
          ...
          >
            ...
            <div className="p-4 bg-amber-400 text-black flex justify-between items-center">
              ...
              <button onClick={toggleChat} className="hover:bg-black/10 p-1 rounded-full transition-colors focus-visible:ring-2 focus-visible:ring-black focus-visible:outline-none" aria-label="Close AI Assistant">
                <X size={18} />
              </button>
            </div>
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.95 }}
        onClick={toggleChat}
        className="w-16 h-16 bg-amber-400 text-black rounded-full flex items-center justify-center shadow-2xl hover:shadow-amber-400/40 transition-all border-4 border-black group focus-visible:ring-2 focus-visible:ring-amber-400 focus-visible:ring-offset-2 focus-visible:ring-offset-[#0a0a0a] focus-visible:outline-none"
