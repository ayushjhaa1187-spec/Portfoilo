...
const Navbar = () => {
  ...
  // ⚡ Bolt: Optimize scroll tracking using Framer Motion
  // Replaces React state (which causes re-renders on every scroll tick)
  // with highly optimized useScroll and useSpring that run outside React's render loop
