              ...
              <div className="p-8 h-full flex flex-col">
                ...
                <div className="mt-8 pt-6 border-t border-white/5 flex justify-between items-center">
                   ...
                   {('liveUrl' in project ? project.liveUrl : false) ? (
                      <a href={('liveUrl' in project ? project.liveUrl : '') as string} target="_blank" rel="noopener noreferrer" className="text-[10px] font-black text-slate-500 hover:text-white transition-colors tracking-widest">
                        LIVE DEMO ↗
                      </a>
                   ) : null}
                </div>
