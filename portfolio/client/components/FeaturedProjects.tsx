...
// ⚡ Bolt: Moved static categories outside of the component to prevent unnecessary object recreation on every render.
const CATEGORIES = ['ALL', 'ML/AI', 'BUSINESS', 'LABS'];

export const FeaturedProjects = () => {
  const [activeTab, setActiveTab] = React.useState('ALL');

  // ⚡ Bolt: Memoized the expensive O(n) array filtering operation.
  // It now only re-runs when the activeTab state changes, preventing recalculations on every single render cycle.
