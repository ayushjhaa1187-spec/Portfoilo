    ...
    const handleScroll = () => {
      if (!ticking) {
        window.requestAnimationFrame(() => {
          // Optimization: Wrap scroll state updates in requestAnimationFrame to prevent layout thrashing and unnecessary re-renders during high-frequency scroll events
