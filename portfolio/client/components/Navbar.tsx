    ...
    const handleScroll = () => {
      if (!ticking) {
        window.requestAnimationFrame(() => {
          // ⚡ Bolt: Optimizing high-frequency scroll event to prevent main thread blocking
          // Reduces unnecessary React re-renders by syncing state updates with screen refresh rate (max 60fps)
