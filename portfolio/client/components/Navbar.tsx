...
const Navbar = () => {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      if (!ticking) {
        window.requestAnimationFrame(() => {
          // ⚡ Bolt: Optimize scroll listener with requestAnimationFrame
          // Reduces state updates to match display refresh rate (~60fps max),
    ...
    // ⚡ Bolt: Use passive listener to prevent scroll blocking
