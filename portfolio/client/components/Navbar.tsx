...
const Navbar = () => {
  ...
  useEffect(() => {
    ...
    // Throttling scroll listener using requestAnimationFrame and a passive event listener.
    // Reduces unnecessary main thread execution and excessive re-renders during high-frequency scroll events.
    let ticking = false;
